...
*/
-- CreateEnum
CREATE TYPE "StoryState2" AS ENUM ('IN_PROGRESS', 'NEW', 'READY', 'DELIVERED', 'IN_REVIEW', 'DONE', 'DELETED');

-- AlterTable
ALTER TABLE "Story" DROP COLUMN "state",
ADD COLUMN     "state" "StoryState2" NOT NULL DEFAULT 'NEW';

-- DropEnum
DROP TYPE "StoryState";
