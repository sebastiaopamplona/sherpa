...
const navigation = [
  { name: "Time Keeper", href: "/timekeeper" },
...
const isCurrentTab = (title: string, tabName: string): boolean => {
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                  {navigation.map((item) => (
                    <Disclosure.Button
                      ...
                      aria-current={
                        isCurrentTab(title, item.name) ? "page" : undefined
                      }
                    >
                      {item.name}
                    </Disclosure.Button>
